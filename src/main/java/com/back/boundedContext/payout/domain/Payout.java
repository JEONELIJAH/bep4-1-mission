...
public class Payout extends BaseIdAndTime {
    ...
    public PayoutItem addItem(PayoutEventType eventType, String relType, int relId, LocalDateTime payDate, PayoutMember payer, PayoutMember payee, long amount) {
        PayoutItem payoutItem = new PayoutItem(
                this, eventType, relType, relId, payDate, payer, payee, amount
        );
